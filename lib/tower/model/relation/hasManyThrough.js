...
Tower.Model.Relation.HasManyThrough = (function(_super) {
  ...
  __defineProperty(HasManyThrough,  "initialize", function(options) {
    var throughRelation;
...
Tower.Model.Relation.HasManyThrough.Criteria = (function(_super) {
  ...
  __defineProperty(Criteria,  "isHasManyThrough", true);
  ...
  __defineProperty(Criteria,  "appendThroughConditions", function(callback) {
    var _this = this;
  ...
  __defineProperty(Criteria,  "createThroughRelation", function(records, callback) {
