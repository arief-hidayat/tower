...
Tower.Model.Attribute = (function() {
  ...
  __defineStaticProperty(Attribute,  "string", {
  ...
  __defineStaticProperty(Attribute,  "number", {
    from: function(serialized) {
      if (Tower.none(serialized)) {
        return null;
      } else {
  ...
  __defineStaticProperty(Attribute,  "integer", {
    from: function(serialized) {
      if (Tower.none(serialized)) {
        return null;
      } else {
  ...
  __defineStaticProperty(Attribute,  "float", {
    from: function(serialized) {
  ...
  __defineStaticProperty(Attribute,  "decimal", Attribute.float);

  __defineStaticProperty(Attribute,  "boolean", {
    from: function(serialized) {
  ...
  __defineStaticProperty(Attribute,  "date", {
    from: function(date) {
      return date;
    },
    to: function(date) {
  ...
  __defineStaticProperty(Attribute,  "time", Attribute.date);

  __defineStaticProperty(Attribute,  "datetime", Attribute.date);

  __defineStaticProperty(Attribute,  "geo", {
    from: function(serialized) {
      return serialized;
    },
    to: function(deserialized) {
  ...
  __defineStaticProperty(Attribute,  "array", {
    from: function(serialized) {
      if (Tower.none(serialized)) {
        return null;
      } else {
